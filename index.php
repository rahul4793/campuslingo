	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">CampusLingo</h1>
			</div>
					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="social-networks">
								<a href="https://www.linkedin.com/in/rahul-gupta-006434203/" class="fa fa-facebook"></a>
								<a href="https://www.linkedin.com/in/rahul-gupta-006434203/" class="fa fa-twitter"></a>
								<a href="https://www.linkedin.com/in/rahul-gupta-006434203/" class="fa fa-instagram"></a>
								<a href="" class="fa fa-reddit"></a>
								<a href="https://www.linkedin.com/in/rahul-gupta-006434203/" class="fa fa-linkedin"></a>
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/sunil1.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Rahul Gupta</h4>
									<h4 class="team-member-designat	ion">Backend Developer</h4>
									<ul class="social-list">
										<li><a href="https://www.linkedin.com/in/rahul-gupta-006434203/" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https://www.linkedin.com/in/rahul-gupta-006434203/" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
							...
							<div class="team-member text-center">
								<img src="img/1632219899658.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Samuel Singh</h4>
									<h4 class="team-member-designation">Front-end Developer</h4>
									<ul class="social-list">
										<li><a href="https://www.linkedin.com/in/samuel-singh-71423a16a/" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https://www.linkedin.com/in/samuel-singh-71423a16a/" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
										<li><a href="https://www.linkedin.com/in/samuel-singh-71423a16a/" class="social-icon icon-gray"><i class="fa fa-google-plus"></i></a></li>
									</ul>
								</div>
							</div>
							...
							<div class="team-member text-center">
								<img src="img/deepak1.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Neha Reddy</h4>
									<h4 class="team-member-designation">Documentation</h4>
									<ul class="social-list">
							...
							<div class="panel-group" id="accordian">
								...
								<?php 
								  ...
								  $con=mysqli_connect('localhost','root');
									...
									mysqli_select_db($con,'campuslingo');
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												CampusLingo is an online E-learning website <br>
